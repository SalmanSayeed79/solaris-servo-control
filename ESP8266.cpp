...
int ESP8266::httpGet()
{
  char* request =  "GET /api/temporal/daily/optimum?latitude=23.8103&longitude=90.4125\r\nHost: rafeedbhuiyan17.pythonanywhere.com\r\nConnection: close\r\n\r\n";

  if (createTCP("rafeedbhuiyan17.pythonanywhere.com", 80))
  {
